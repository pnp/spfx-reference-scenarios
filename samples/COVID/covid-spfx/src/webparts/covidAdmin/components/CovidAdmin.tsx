            ...
            <>
              ...
              {this.state.tab === ADMINTABS.TODAY &&
                <>
                  ...
                  <Dialog header={strings.ReviewCheckInHeader} content={strings.ReviewCheckInContent} visible={this.state.reviewFormVisible} onChange={this._changeReviewVisibility} height={70}>
