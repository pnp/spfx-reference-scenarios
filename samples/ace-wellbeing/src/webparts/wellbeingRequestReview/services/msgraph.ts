...
export class MSGraph {
    ...
    public static async Get(apiUrl: string, version: string = "v1.0", selectProperties?: string[], expandProperties?: string[], filter?: string, top?: number, orderby?: string): Promise<any> {
